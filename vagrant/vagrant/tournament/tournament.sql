...
CREATE TABLE T_RESULTS(
	...
	ID_TOURN INTEGER REFERENCES T_TOURNAMENTS (ID_TOURN) ON DELETE CASCADE,
	ID_MATCH INTEGER, -- REFERENCES T_MATCHES (ID_MATCH) ON DELETE CASCADE,
	ID_Player INTEGER REFERENCES T_PLAYERS (ID_Player) ON DELETE CASCADE,
	ID_WIN_LOSE CHAR,
	ID_ELIMIN BOOLEAN
);
